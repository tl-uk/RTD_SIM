...
class TestEndToEnd(unittest.TestCase):
    ...
    def test_T25_full_pipeline_with_mocked_llm(self):
        ...
        # anthropic is imported lazily inside _extract_library() with `import anthropic`.
        # patch() cannot target it as a module attribute — patch sys.modules instead
        # so the `import anthropic` call inside the function receives our mock.
        import sys
