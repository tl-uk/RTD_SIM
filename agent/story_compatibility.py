...
# (app startup, sidebar, agent creation, Combination Report tab) with
...
# change at runtime (e.g. after story ingestion or hot-reload).
...
def clear_compatibility_cache() -> None:
    ...
    Call this after the story library is updated (e.g. ingestion
...
COMPATIBLE_USERS_FOR_JOB = {
    ...
    # ========================================================================
    # STUBS — *_generated jobs (NO YAML YET)
    ...
    # until FreightOperatorAgent is implemented.
    # ========================================================================
...
def create_realistic_agent_pool(
    ...
    BUG fix: the previous implementation assigned agents in strict
